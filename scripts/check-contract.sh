...
for script in load-smoke migration-smoke backup-restore-smoke failure-injection-smoke rollback-smoke g5-smoke graph-smoke import-review-smoke g6-batch-smoke apply-curriculum-mapping-migration apply-question-graph-migration apply-import-review-migration; do
